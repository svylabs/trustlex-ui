...
export const listOffers = async (trustLex: ethers.Contract | undefined, fromBlock: number = 0, toBlock: "latest" | number = "latest")  => {
  try {
    if (!trustLex) return { fromBlock: fromBlock, toBlock: toBlock, offers: []};
